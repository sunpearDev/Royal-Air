    ...
    <div class="progress-table-wrap  m-5 p-4">
        <div class="progress-table">
            <div class="table-head">
                ...
                <div class="country">Room for <?php echo $_GET['adult']?> and <?php echo $_GET['child']?> child</div>
                            ...
                            <div class="col-8 d-flex flex-column position-static">
                                <div class="row">
                                    <div class="col-md-8"><strong class="d-inline-block mb-2 text-primary">World</strong>
                                        ...
                                        <div class="mb-0">1 single bed <img width='16px' class="bed" src="image/single-bed.png" /> ,1 double bed <img width='16px' class="bed" src="image/double-bed.jpg" /></div>
