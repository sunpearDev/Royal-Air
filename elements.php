...
<body>
	...
	<section class="breadcrumb_area blog_banner_two">
		...
		<div class="container">
			<div class="page-cover text-center">
				<h2 class="page-cover-tittle f_48">Phạm vi hoạt động</h2>
				<ol class="breadcrumb">
					<li><a href="index.html">Trang chủ</a></li>
					<li class="active">Phạm vi hoạt động</li>
				</ol>
			</div>
		</div>
	</section>
	...
	<section class="sample-text-area">
		<div class="container">
			<h3 class="text-heading title_color">Mẫu văn bản</h3>
			<p class="sample-text">
			Mọi nhà làm phim độc lập khao khát đều <b> Bold </b> về việc làm phim tài liệu về sở thích <i> In nghiêng </i> đó,
hoặc phim ngắn để thể hiện năng lực sáng tạo của họ. Nhiều người có ý tưởng tuyệt vời và muốn "ồ"
cảnh <sup> Superscript </sup> hoặc những người cho thuê video với dự án lớn của họ. Nhưng một khi bạn có
<sub> Subscript </sub> “in the can” (không dễ đâu), làm cách nào để bạn chuyển từ <del> Strike </del> qua
chính DVD với tiêu đề viết tay được đánh dấu <u> “Underline” </u> bên trong hộp CD cũ, thành một đống
hộp các tông chứa đầy đĩa DVD mới sáng bóng, sẵn sàng bán lẻ, với mã vạch UPC và polywrap ngồi trên
bậc cửa? Bạn cần tạo ra tác phẩm nghệ thuật bắt mắt và nhân rộng dự án của mình. Sử dụng một
công ty nhân bản DVD đầy đủ dịch vụ như PacificDisc, Inc. để hợp tác chắc chắn là một
tùy chọn để đảm bảo kết quả cuối cùng chuyên nghiệp, nhưng để trợ giúp với dự án sao chép DVD của bạn, đây là 4
các bước đơn giản để làm theo để có kết quả sao chép DVD tốt:
